...
- `zero_curve_panel` / `term_premium_analysis` (ACM on GSW or on the app's own factor history, Kim-Wright benchmark with per-maturity correlation and mean gap, Diebold-Li split, regressions);
